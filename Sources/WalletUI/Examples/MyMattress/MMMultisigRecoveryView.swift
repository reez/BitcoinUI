    ...
    ZStack {
      ...
      VStack(spacing: 20.0) {
        ...
        VStack(spacing: 5.0) {
          ...
          Text(
            "It is possible to create a new wallet and transfer your funds over. This new wallet will not rely on access to the Coldcard you lost."
          )
          .font(.title3)
          .foregroundColor(Color(UIColor.secondaryLabel))
          .multilineTextAlignment(.center)
    ...
    ZStack {
      ...
      VStack(spacing: 20.0) {
        ...
        VStack(spacing: 5.0) {
          ...
          Text(
            "By losing cloud both hardware devices, it is technically no longer possible to make transactions with this wallet."
          )
          .font(.title3)
          .foregroundColor(Color(UIColor.secondaryLabel))
          .multilineTextAlignment(.center)
          ...
          Text(
            "Have you tried recovering your hardware devices via their respective recovery mechanisms? It may be possible to recover one of the wallets from backup to a new device."
          )
          .font(.title3)
          .foregroundColor(Color(UIColor.secondaryLabel))
          .multilineTextAlignment(.center)
