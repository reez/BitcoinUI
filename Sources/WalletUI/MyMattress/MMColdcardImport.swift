    ...
    ZStack {
      ...
      VStack(spacing: 20.0) {
        ...
        VStack(spacing: 5.0) {
          ...
          Text(
            "Make sure you have a Coldcard device and a Lightning SD Card adapter for your iPhone at hand."
          )
          .font(.title3)
    ...
    ZStack {
      ...
      VStack(spacing: 20.0) {
        ...
        VStack(spacing: 5.0) {
          ...
          Text(
            "Remove the SD card from your Coldcard and connect it to your phone via the adapter."
          )
          .font(.title3)
          .foregroundColor(Color(UIColor.secondaryLabel))
          .multilineTextAlignment(.center)
