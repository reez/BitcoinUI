      ...
      label: {
        VStack {
          Text(number)
            .font(.title2)
            .foregroundColor(
              numberIsHidden ? Color.clear : Color(UIColor.label)
            )
          Text(letters.uppercased())
            .font(.title3)
            .foregroundColor(
              letterIsHidden ? Color.clear : Color(UIColor.secondaryLabel)
            )
      ...
      VStack {
        ...
        VStack(alignment: .center) {
          HStack {
            ...
            Spacer()
            NumberButtonView(
              number: "2", letters: "abc", numberIsHidden: false, letterIsHidden: false
            )
            .frame(maxWidth: .infinity)
            Spacer()
            NumberButtonView(
              number: "3", letters: "def", numberIsHidden: false, letterIsHidden: false
            )
            .frame(maxWidth: .infinity)
          }
          .padding(.vertical)
          ...
          HStack {
            NumberButtonView(
              number: "4", letters: "ghi", numberIsHidden: false, letterIsHidden: false
            )
            .frame(maxWidth: .infinity)
            Spacer()
            NumberButtonView(
              number: "5", letters: "jkl", numberIsHidden: false, letterIsHidden: false
            )
            .frame(maxWidth: .infinity)
            Spacer()
            NumberButtonView(
              number: "6", letters: "mno", numberIsHidden: false, letterIsHidden: false
            )
            .frame(maxWidth: .infinity)
          }
          .padding(.vertical)
          ...
          HStack {
            NumberButtonView(
              number: "7", letters: "pqrs", numberIsHidden: false, letterIsHidden: false
            )
            .frame(maxWidth: .infinity)
            Spacer()
            NumberButtonView(
              number: "8", letters: "tuv", numberIsHidden: false, letterIsHidden: false
            )
            .frame(maxWidth: .infinity)
            Spacer()
            NumberButtonView(
              number: "9", letters: "wxyz", numberIsHidden: false, letterIsHidden: false
            )
            .frame(maxWidth: .infinity)
          }
          .padding(.vertical)
          ...
          HStack {
            ...
            Spacer()
            NumberButtonView(
              number: "0", letters: "aaa", numberIsHidden: false, letterIsHidden: false
            )
            .frame(maxWidth: .infinity)
            Spacer()
            VStack {
