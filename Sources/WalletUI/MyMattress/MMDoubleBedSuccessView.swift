    ...
    ZStack {
      ...
      VStack(spacing: 20.0) {
        ...
        VStack(spacing: 5.0) {
          ...
          Text(
            "If you can, store them in different locations. If one gets lost, you still have the other one. And a thief cannot access your funds with just a single hardware device."
          )
          .font(.title3)
          .foregroundColor(Color(UIColor.secondaryLabel))
          .multilineTextAlignment(.center)
    ...
    ZStack {
      ...
      VStack(spacing: 20.0) {
        ...
        VStack(spacing: 5.0) {
          ...
          Text(
            "Your funds can be recovered if you lose this phone, a hardware device, or your cloud backups."
          )
          .font(.title3)
          .foregroundColor(Color(UIColor.secondaryLabel))
          .multilineTextAlignment(.center)
