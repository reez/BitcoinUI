...
struct MMSettingsDefaultView: View {
  let settings = [
    MMSetting(
      backup: "", color: .bitcoinOrange, imageName: "paperplane.fill", imageBitcoin: false,
      status: "Set recovery email", detail: nil),
    MMSetting(
      backup: "", color: .bitcoinGreen, imageName: "ellipsis", imageBitcoin: false,
      status: "Change PIN", detail: nil),
    MMSetting(
      backup: "Cloud backup", color: .blue, imageName: "singlebedsettings-group",
      imageBitcoin: true, status: "Security mode", detail: "Single bed"),
    MMSetting(
      backup: "", color: .bitcoinPurple, imageName: "clear.fill", imageBitcoin: false,
      status: "Log out", detail: nil),
  ]
    ...
    ZStack {
      ...
      VStack(spacing: 20.0) {
        ...
        VStack(spacing: 5.0) {
          ...
          Text(
            "Your funds are secured by a single key, which is backed up to your cloud storage provider."
          )
          .font(.title3)
          .foregroundColor(Color(UIColor.secondaryLabel))
          .multilineTextAlignment(.center)
...
struct MMSettingsDefaultDoubleView: View {
  let settings = [
    ...
    MMSetting(
      ...
      status: "Change PIN", detail: nil),
    MMSetting(
      backup: "Cloud backup", color: .blue, imageName: "double-bed-filled", imageBitcoin: true,
      status: "Security mode", detail: "Single bed"),
    MMSetting(
      backup: "", color: .bitcoinPurple, imageName: "clear.fill", imageBitcoin: false,
      status: "Log out", detail: nil),
  ]
