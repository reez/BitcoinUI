    ...
    ZStack {
      ...
      VStack(spacing: 20.0) {
        ...
        VStack(spacing: 5.0) {
          ...
          Text(
            "Review the key configuration below. To transact, you will create transactions on this device and need to sign them with one of your hardware devices."
          )
          .font(.title3)
          .foregroundColor(Color(UIColor.secondaryLabel))
          .multilineTextAlignment(.center)
    ...
    ZStack {
      ...
      VStack(spacing: 20.0) {
        ...
        VStack(spacing: 5.0) {
          ...
          Text(
            "In addition to your own key, you should back up the configuration of this wallet so you can restore it easily at a later point, or another device."
          )
          .font(.title3)
          .foregroundColor(Color(UIColor.secondaryLabel))
          .multilineTextAlignment(.center)
