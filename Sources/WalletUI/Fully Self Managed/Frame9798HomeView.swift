            ...
            VStack(spacing: 20.0) {
                ...
                HStack(spacing: 8.0) {
                    Image(systemName: "bolt.fill")
                        .padding(.vertical)
                        .padding(.leading)
                    Text("Set up instant payments to save time and fees.")
                        .font(.footnote)
                        .padding()
                    Spacer()
...
struct Frame9798HomeView_Previews: PreviewProvider {
